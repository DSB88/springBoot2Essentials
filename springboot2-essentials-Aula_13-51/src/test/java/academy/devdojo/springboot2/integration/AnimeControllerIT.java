...
class AnimeControllerIT {
    ...
    private static final User USER = User.builder()
            .name("William")
            .password("{bcrypt}$2a$10$6Qh3Y2Gp7c3JQxAJ4u7gvO5ghL4I620YIMjC82DJSg7.5kl49Aj4q")
            .username("william")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:"+port)
                    .basicAuthentication("diego", "academys");
            return new TestRestTemplate(restTemplateBuilder);
        }
    }
    ...
    void delete_RemovesAnime_WhenSuccessful() {
        ...
        ResponseEntity<Void> animeResponseEntity = testRestTemplateRoleAdmin.exchange("/animes/api/v1/{id}",
    ...
    void delete_Returns403_WhenUserIsNotAdmin() {
        ...
        ResponseEntity<Void> animeResponseEntity = testRestTemplateRoleUser.exchange("/animes/api/v1/{id}",
                HttpMethod.DELETE, null, Void.class, savedAnime.getId());
